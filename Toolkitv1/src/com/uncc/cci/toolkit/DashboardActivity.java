...
import com.uncc.cci.toolkit.newCampaign.CampaignInfoActivity;
...
public abstract class DashboardActivity extends LoginActivity 
{
...
/*      case R.id.home_btn_feature2 :
      ...
      case R.id.home_btn_feature3 :
           startActivity (new Intent(getApplicationContext(), CampaignInfoActivity.class));
           break;
/*      case R.id.home_btn_feature4 :
           startActivity (new Intent(getApplicationContext(), F4Activity.class));
           break;*/
      case R.id.home_btn_feature5 :
           //startActivity (new Intent(getApplicationContext(), JoinCampaignActivity.class));
           break;
